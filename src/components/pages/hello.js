...
export default class HelloComponent extends Component {
  ...
  render() {
    return (
      <div>
          {  !this.props.user.user ? <p>没有登录呀</p>  : <div><p>hello { this.props.user.user } 请完善你的信息</p>  
        ...
        <WhiteSpace></WhiteSpace>
        {this.props.user.isUpdate == true 
         ? <Redirect to='/'></Redirect> 
         : this.props.user.user  && this.props.user.isUpdate !== true
         ? <div>更新失败</div> 
         : null 
         }
      </div>
